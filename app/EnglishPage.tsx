  ...
  return (
    <main>
      ...
      <section className="section firmware-section" id="control">
        <div className="section-head"><span>03 / MOTION CONTROLLER</span><h2>It must move—<br />and it must stop.</h2><p>The C++ core and ESP32-S3 adapter compile with quadrature encoders, MPU6050 and dual INA226 current sensing. MDD20A PWM-low means brake rather than isolation. Stage 19 now freezes the equation `PWM_OUT = POWER AND PWM_IN AND SAFE_A AND SAFE_B AND ALERT_N`, its 64-row truth table and a formal KiCad 10 schematic. ERC has zero violations and the canonical CSV cross-audits against the KiCad XML netlist. The safety relay and normally-open contactor still provide bus isolation; independent peer review, PCB/DRC, Gerber, powered and running validation remain pending.</p></div>
