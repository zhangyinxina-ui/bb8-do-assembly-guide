    ...
    <main>
      ...
      <section className="section structure">
        ...
        <div className="mechanism">
          ...
          <div><span className="kicker">BUILDABLE CORE / STAGE 18 APPLIED + AUDITED</span><h3>Editable parts,<br />not a concept image.</h3>
            <p>The saved Blender master now contains 150 fabrication objects plus nine non-fabrication engineering markers. Wheels and four stabilisers reach the 254 mm inner shell; IG42E-24K envelopes use 125.2 mm length, 35 mm PCD mounts and 310 mm track. Stage 17 screens MDD20A, a provisional 30 A MIDI fuse, SW60 and a P28A 4S2P candidate against official data. Stage 18 writes 39 power-cassette objects—including a dedicated REC Active BMS 4S—into the sole master, with 27.643 mm shell, 7.500 mm candidate-to-candidate and 6.000 mm protected-mechanism minimum clearance. The reopened master passes the Blender audit; twelve physical freeze gates remain open, so the geometry is not a claim of purchased or tested hardware.</p>
      ...
      <section className="section firmware-section" id="control">
        <div className="section-head"><span>03 / MOTION CONTROLLER</span><h2>It must move—<br />and it must stop.</h2><p>The C++ core and ESP32-S3 adapter compile with quadrature encoders, MPU6050 and dual INA226 current sensing. Stage 16 emits fixed timestamped telemetry. Stage 17 shows that MDD20A has adequate catalogue ratings, but PWM-low means brake rather than isolation. Stage 18 writes the separate dual-channel gate, upstream contactor, external shunt and dedicated 4S BMS into the removable power-cassette geometry and passes a reopen audit; physical fit, powered and running validation remain pending.</p></div>
