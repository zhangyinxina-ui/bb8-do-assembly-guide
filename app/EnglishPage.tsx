      ...
      <section className="section structure">
        ...
        <div className="mechanism">
          ...
          <div><span className="kicker">BUILDABLE CORE / STAGE 19 PRE-CAD GATE</span><h3>Editable parts,<br />not a concept image.</h3>
            <p>The saved Blender master contains 150 fabrication objects plus nine non-fabrication engineering markers. Stage 18 writes 39 power-cassette objects into the sole master with 27.643 mm shell, 7.500 mm candidate and 6.000 mm protected-mechanism clearance. The reopened master passes the Blender audit. Stage 19 now releases a pre-CAD dual-permissive PWM contract: loss of SAFE_A, SAFE_B, INA226 ALERT_N or 3.3 V blocks both PWM outputs in all 64 Boolean combinations. No KiCad, Gerber or bench waveform exists, so this remains a reference design—not purchased, fabricated or tested hardware.</p>
