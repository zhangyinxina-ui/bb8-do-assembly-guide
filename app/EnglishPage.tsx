    ...
    <main>
      ...
      <section className="section structure">
        ...
        <div className="mechanism">
          ...
          <div><span className="kicker">BUILDABLE CORE / STAGE 16</span><h3>Editable parts,<br />not a concept image.</h3>
            <p>The Blender master contains 147 fabrication objects plus three non-fabrication engineering markers. Wheels and four stabilisers reach the 254 mm inner shell; IG42E-24K envelopes use 125.2 mm length, 35 mm PCD mounts and 310 mm track. Stage 14 adds the removable 1.50 kg sealed ballast cassette. Stage 15 adds explicit left/right motor-driver envelopes, heatsinks, main fuse, normally-open contactor, dual-channel normally-closed E-stop, safety relay, service disconnect and tether jack. Stage 16 adds nineteen real-hardware evidence gates without pretending that geometry is a physical test: the current score is 0/19.</p>
      ...
      <section className="section firmware-section" id="control">
        <div className="section-head"><span>03 / MOTION CONTROLLER</span><h2>It must move—<br />and it must stop.</h2><p>The C++ core and ESP32-S3 adapter compile with quadrature encoders, MPU6050 and dual INA226 current sensing. Stage 15 turns the fuse, normally-open contactor, dual-channel E-stop and both driver-enable branches into an explicit physical contract. Stage 16 emits fixed timestamped telemetry every 200 ms and requires measured files plus matching SHA-256 before any physical PASS.</p></div>
