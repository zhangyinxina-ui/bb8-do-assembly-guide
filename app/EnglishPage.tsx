    ...
    <main>
      ...
      <section className="section structure">
        ...
        <div className="mechanism">
          ...
          <div><span className="kicker">BUILDABLE CORE / STAGE 17</span><h3>Editable parts,<br />not a concept image.</h3>
            <p>The Blender master contains 147 fabrication objects plus three non-fabrication engineering markers. Wheels and four stabilisers reach the 254 mm inner shell; IG42E-24K envelopes use 125.2 mm length, 35 mm PCD mounts and 310 mm track. Stage 14 adds the removable 1.50 kg sealed ballast cassette. Stage 15 adds the explicit power-cutoff hardware, and Stage 16 adds nineteen physical evidence gates. Stage 17 screens MDD20A, a provisional 30 A MIDI fuse, SW60 and a P28A 4S2P candidate against official data: all 15 rating checks pass, but hard-disable adaptation, regeneration, stall current, BMS and pack release remain HOLD.</p>
      ...
      <section className="section firmware-section" id="control">
        <div className="section-head"><span>03 / MOTION CONTROLLER</span><h2>It must move—<br />and it must stop.</h2><p>The C++ core and ESP32-S3 adapter compile with quadrature encoders, MPU6050 and dual INA226 current sensing. Stage 16 emits fixed timestamped telemetry. Stage 17 shows that MDD20A has adequate catalogue ratings, but PWM-low means brake rather than isolation; a separately verified dual-channel hardware gate and upstream contactor must remove energy.</p></div>
