    ...
    <main>
      ...
      <section className="section do-section" id="do">
        ...
        <div className="do-grid">
          ...
          <div><span>CONTROL CODE</span><strong>Version pinned</strong><p>Printed Droid v3.4.3 is pinned to e90aacd. Its README allows personal non-commercial use, modification and distribution with notice and attribution. Mega 2560 compilation passes at 17% flash and 18% RAM. The generic website v3.4 ZIP is still v3.4.0 and is historical only.</p></div>
