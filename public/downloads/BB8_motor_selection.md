...
- 96 mm 驱动轮；每电机连续需求 0.299 N·m；目标地速 1.0 m/s。
- 连续扭矩最低设计裕量 2.0×。
...
|---|---:|---:|---:|---|
| Sha Yang Ye / Cytron IG42E-24K | 248 rpm / 0.980 N·m | 1.25 m/s | 3.28× | 进入阶段5可装配接口 |
| Pololu 4692 30:1 37D 24V encoder | 280 rpm / 0.186 N·m | 1.41 m/s | 0.62× | 不作为当前连续工况首选 |
...
Pololu 4692体积和编码器分辨率更好，但厂家最大效率点扭矩仅约0.186 N·m，低于阶段14的0.299 N·m需求。即使其失速外推值较高，也不应把失速值当连续额定值。
